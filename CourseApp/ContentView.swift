...
//                        .repeatForever(autoreverses: true)
            ...
            BackCardView()
                .frame(width: showCard ? 300 : screen.width - 60, height: 220)
            ...
            BackCardView()
                .frame(width: screen.width - 60, height: 220)
            ...
            CardView()
                .frame(width: showCard ? screen.width : screen.width - 60, height: 220.0)
